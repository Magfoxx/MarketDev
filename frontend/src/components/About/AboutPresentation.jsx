...
const AboutPresentation = () => {
  return (
    <div className="max-w-5xl flex flex-col-reverse md:flex-row items-center gap-12 bg-gray-200 dark:bg-gray-800 rounded-xl px-6 py-8 ">
      {/* Compétences */}
      <div className="flex-1 text-center p-6 rounded-lg bg-gray-100 dark:bg-secondary">
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 gap-6 text-gray-700 text-5xl md:text-4xl">
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs xl:text-sm font-medium text-secondary dark:text-white mt-2">
              HTML5
            </span>
          </div>
          <div className="flex flex-col items-center">
